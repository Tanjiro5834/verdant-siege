...
class Unit {
    ...
    public function __construct(string $type, int $row, int $col, array $stats) {
        $this->id = uniqid();
        $this->type = $type;
        $this->row = $row;
        $this->col = $col;
    ...
    public function getRange(): float { return $this->range; }
    public function isAttacking(): bool { return $this->isAttacking; }
    public function setPosition(int $row, int $col): void {
        $this->row = $row;
        $this->col = $col;
    }
}
